...
import { CheckCircle2, Clock, Fuel } from 'lucide-react';
  ...
  return (
    <div className="mx-auto w-full max-w-[640px] px-3 py-4">
      ...
      <div className="background-container">
        <TypeTabs activeType="delivery" />

        <div className="mb-4">
          <h2>Fuel deliveries</h2>
          <p className="steps-text mt-1">
            Review recent incoming fuel movements and evidence status.
          </p>
        </div>
        ...
        {!loading && !error && transactions.length > 0 && (
          <FuelTransactionsList transactions={transactions} type="delivery" />
        )}
      </div>
    </div>
  );
